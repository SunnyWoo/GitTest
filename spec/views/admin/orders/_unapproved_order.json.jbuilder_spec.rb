...
RSpec.describe 'admin/orders/_unapproved_order.json.jbuilder', :caching, type: :view do
  let(:order) { Admin::OrderDecorator.new(create(:order)) }

  it 'renders order' do
    render 'admin/orders/unapproved_order', order: order
